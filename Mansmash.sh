...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing Mansmash Made by Mahfuz'
    else
        figlet Mansmash
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32Founder of Dark-Evil MR. Mahfuz Rahman \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Mahfuz Rahman
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           facebook https://facebook.com/mahfuz038"
    echo -e "\e[4;32m           whatsapp sorry i cant provide my personal number"
    echo " "
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN Mansmash Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
